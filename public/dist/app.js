...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_wysiwyg__ = __webpack_require__(34);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2_vue_wysiwyg___default.a, {
    image: {
        uploadURL: "/uploads",
        dropzoneOptions: {},
...
Vue.component('todo-list', __webpack_require__(36));
...
Component.options.__file = "resources/js/backend/todo/list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7fd73e7e", Component.options)
  } else {
    hotAPI.reload("data-v-7fd73e7e", Component.options)
  }
...
var update = __webpack_require__(40)("043353e8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7fd73e7e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./list.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7fd73e7e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./list.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addToList: function addToList() {
      ...
      var baseURI = './api/list/create';
      this.$http.post(baseURI, { title: this.add_note_title, description: this.add_note_description, color: this.add_note_color }).then(function (result) {
        _this.loadList();
      });
    ...
    removeFromList: function removeFromList(l) {
      var _this2 = this;

      if (confirm('Are you sure you want to remove this note from your list?')) {
        this.$http.delete('api/list/' + l.id + '/destroy').then(function (result) {
          _this2.loadList();
        });
      } else {
        // Do nothing!
    ...
    updateNoteColor: function updateNoteColor(l) {
      var _this3 = this;

      this.$http.post('api/list/' + l.id + '/update', l).then(function (result) {
        _this3.loadList();
      });
    },
    editNote: function editNote(l) {
      var _this4 = this;
    ...
    loadList: function loadList() {
      ...
      this.$http.get('./api/list').then(function (result) {
        console.log('reload');
        _this5.notes = result.data;
        console.log(result.data);
      });
    },
    stopNoteEdit: function stopNoteEdit() {
  ...
  computed: {
    reverseNotes: function reverseNotes() {
    ...
    _c("div", { staticClass: "container mt-5" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-md-6 offset-md-3" }, [
          _c("h1", { staticClass: "mb-3" }, [_vm._v("Notes")]),
          _vm._v(" "),
          !_vm.createNote
            ? _c(
                "span",
                {
                  staticClass: "createNote pt-3 pb-3",
                  on: {
              ...
              _vm.createNote
                ? _c(
                    "form",
                    {
                      ...
                      style: { "background-color": "#" + _vm.add_note_color },
                      attrs: { action: "post" },
                      on: {
                    ...
                    [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.add_note_title,
                            expression: "add_note_title"
                          }
                        ],
                        ...
                        domProps: { value: _vm.add_note_title },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.add_note_title = $event.target.value
                          }
                        }
                      }),
                      _vm._v(" "),
                      _c("textarea", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.add_note_description,
                            expression: "add_note_description"
                          }
                        ],
                        attrs: {
                          name: "description",
                        ...
                        domProps: { value: _vm.add_note_description },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.add_note_description = $event.target.value
                          }
                        }
                      }),
                      _vm._v(" "),
                      ...
                      _c(
                        "ul",
                        { staticClass: "colorPallet" },
                        _vm._l(_vm.colors, function(c, i) {
                          return _c("li", {
                            style: { "background-color": "#" + c },
                            on: {
                              click: function($event) {
                                _vm.add_note_color = c
                              }
                            }
                          })
                        }),
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm._l(_vm.reverseNotes, function(l, i) {
                return _c(
                  "li",
                  {
                    staticClass:
                      "list-group-item d-flex justify-content-between align-items-center mb-4",
                    style: { "background-color": "#" + l.color },
                    on: {
                      dblclick: function($event) {
                        l.edit = true
                        _vm.createNote = false
                        _vm.stopNoteEdit(l)
                      }
                    }
                  },
                  [
                    l.edit
                      ? _c(
                          "form",
                          {
                            staticClass: " editNote ",
                            attrs: { action: "post" },
                            on: {
                              submit: function($event) {
                                $event.preventDefault()
                                return _vm.editNote(l)
                              }
                            }
                          },
                          [
                    ...
                    !l.edit
                      ? _c("div", [
                          l.title
                            ? _c("span", { staticClass: "noteTitle pb-2" }, [
                                _vm._v(
                                  "\n                " +
                                    _vm._s(l.title) +
                                    "\n              "
                          ...
                          _vm._v(" "),
                          _c("span", {
                            domProps: { innerHTML: _vm._s(l.description) }
                          })
                        ])
                      : _vm._e(),
                    _vm._v(" "),
          ...
          _vm._v(" "),
          _c("small", [_vm._v("*Double Click to Edit")]),
          _c("br"),
          _vm._v(" "),
          _c("small", [_vm._v("created by  sakkoulas@gmail.com")])
        ])
      ])
    ])
  ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "text-right" }, [
      _c("button", { staticClass: "m-1 btn btn-default card-link done" }, [
        _vm._v("Done")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "text-right" }, [
      _c("button", { staticClass: "btn btn-default card-link done" }, [
        _vm._v("Done")
      ])
    ])
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7fd73e7e", module.exports)
  }
}
